 ...
 * 
 * referenced:  http://condor.depaul.edu/glancast/374class/docs/slides/Apr09/slide9.html;
 * 		https://github.com/mightydeveloper/Shell-Lab/blob/master/tsh.c;
 * 		https://github.com/modimrugesh1910/tsh.c-Shell-Project/blob/master/tsh.c;
 */
#include <stdio.h>
#include <stdlib.h>
#include <unistd.h>
